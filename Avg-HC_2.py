...
if __name__ == '__main__':
    ...
    fh = logging.FileHandler(
        f'./log/z_logger_Avg_E_{E}_rho_{rho}_m_{m}_n_{n}_m_i_{m_i}_v_max_{v_max}_eps_pri_{eps_pri}_eps_dual_{eps_dual}_alpha_{alpha}.log',
        'w')
    ...
    # 保存为 csv 文件
    df.to_csv(
        f'./csv/data_Avg_E_{E}_rho_{rho}_m_{m}_n_{n}_m_i_{m_i}_v_max_{v_max}_iter_{N_iter}_eps_pri_{eps_pri}_eps_dual_{eps_dual}_alpha_{alpha}.csv',
        index=False)
